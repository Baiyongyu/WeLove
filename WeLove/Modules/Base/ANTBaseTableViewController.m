...
@interface ANTBaseTableViewController ()
...
@implementation ANTBaseTableViewController
...
- (void)viewDidLoad
{
    ...
    self.arrowUpView=[[ArrowView alloc] initWithFrame:CGRectMake(0,kScreenHeight,kScreenWidth, 50)];
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if(self.enableNextPage)
    {
        ...
        self.arrowUpView.frame=CGRectMake(0,self.tableView.contentSize.height,kScreenWidth, 50);
...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        self.tipLabel.frame=CGRectMake(0, 0, kScreenWidth, 50);
