...
- (void)loadSubViews {
    ...
    _bgView.image = [UIImage imageNamed:@"homeBg"];
...
- (void)layoutConstraints {
    ...
    [ComAnimationLayer createAnimationLayerWithString:@"小v，我爱你" andRect: CGRectMake(0, 200, self.view.frame.size.width, self.view.frame.size.width) andView:self.view andFont:[UIFont boldSystemFontOfSize:40] andStrokeColor:kNavColor];
}
