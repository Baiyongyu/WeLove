...
- (UIView *)tableViewFooterView {
    UIView *tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 30)];
    
    UILabel *bottomlabel = [[UILabel alloc] initWithFrame:CGRectMake((kScreenWidth - 200) / 2, 0, 200, 12)];
    bottomlabel.text = @"- 我们故事的开始 -";
