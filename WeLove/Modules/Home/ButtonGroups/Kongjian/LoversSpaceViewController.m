...
@interface LoversSpaceViewController () <UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource>
...
- (void)tableViewCell:(TableViewCell *)cell didClickedLikeButtonWithIsLike:(BOOL)isLike {
    ...
    if (isLike) {
        [newLikeList addObject:@"宇哥的粉丝"];
    } else {
        [newLikeList removeObject:@"宇哥的粉丝"];
    }
...
- (void)openTableViewCell:(TableViewCell *)cell {
    ...
    CellLayout* newLayout = [[CellLayout alloc] initContentOpendLayoutWithStatusModel:model
                                                                        ...
                                                                        dateFormatter:[QMUtil dateFormatter]];
...
- (void)keyboardDidAppearNotifications:(NSNotification *)notifications {
    ...
    self.commentView.frame = CGRectMake(0.0f, SCREEN_HEIGHT - 44.0f - 64.0f - keyboardHeight, SCREEN_WIDTH, 44.0f);
}
