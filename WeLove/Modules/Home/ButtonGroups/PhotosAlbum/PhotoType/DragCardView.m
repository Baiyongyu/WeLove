...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, self.frame.size.width+50+10, self.frame.size.width - 40, 20)];
        self.nameLabel.font = [UIFont systemFontOfSize:16];
        self.nameLabel.textColor = [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1];
        [bgView addSubview:self.nameLabel];
        
        UILabel *alertLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, self.frame.size.width +50+30, self.frame.size.width - 40, 20)];
...
- (void)layoutSubviews {
    self.nameLabel.text = [NSString stringWithFormat:@"小v%@号",self.infoDict[@"number"]];
