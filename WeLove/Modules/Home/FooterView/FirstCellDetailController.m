...
@interface FirstCellDetailController ()

@end

@implementation FirstCellDetailController
...
- (void)initViews {
    ...
    [customButton setTitle:@"永远相信美好的事情即将发生" forState:UIControlStateNormal];
    ...
    NSAttributedString *attributedString =[[NSAttributedString alloc] initWithString:@"永远相信美好的事情即将发生" attributes:@{NSForegroundColorAttributeName : RED_COLOR,NSKernAttributeName : @(4.f)}];
    ...
    tipLabel.text = @"点击开启幸福之旅";
    [customButton addSubview:tipLabel];
    //设置字间距
    attributedString =[[NSAttributedString alloc] initWithString:@"点击开启幸福之旅" attributes:@{NSForegroundColorAttributeName : MIDDLE_GRAY_COLOR,NSKernAttributeName : @(4.f)}];
    ...
    userCountLabel.text = [formatter stringFromNumber:@(20161026)];
