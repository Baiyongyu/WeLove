...
#import "TrackSensorListManager.h"

@interface TrackSensorListManager ()
@property (nonatomic, copy, readwrite) NSString *errorMessage;
@end

@implementation TrackSensorListManager
