...
+ (Lunar *)solarToLunar:(Solar *)solar;
{
    ...
    lunar.chineseLunarMonth = chineseMonths[lunar.lunarMonth - 1];
    lunar.chineseLunarDay = chineseDays[lunar.lunarDay - 1];
    return lunar;
}
...
+ (Lunar *)dateToLunar:(NSDate *)date
{
    ...
    solar.solarYear = [year intValue];
    [dateFormatter setDateFormat:@"M"];
    NSString *month = [dateFormatter stringFromDate:date];
    solar.solarMonth = [month intValue];
    [dateFormatter setDateFormat:@"d"];
    NSString *day = [dateFormatter stringFromDate:date];
    solar.solarDay = [day intValue];
