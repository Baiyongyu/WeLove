...
+ (void)createAnimationLayerWithString:(NSString*)string andRect:(CGRect)rect andView:(UIView *)view andFont:(UIFont*)ui_font andStrokeColor:(UIColor*)color {
    ComAnimationLayer * animationLayer = [ComAnimationLayer layer];
    ...
    pathLayer.frame = CGRectMake(0, 0, rect.size.width, rect.size.height -185);
    ...
    heartpathLayer.strokeColor = [kNavColor CGColor];
    heartpathLayer.fillColor = nil;
    heartpathLayer.lineWidth = 2.5f;
    ...
    heartRightLayer.strokeColor = [kNavColor CGColor];
    heartRightLayer.fillColor = nil;
    heartRightLayer.lineWidth = 2.5f;
